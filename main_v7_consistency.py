...
def main() -> None:
    print("=" * 86)
    print("      BursaAI v7 Sprint 7A.5 RC3 — Consistency Engine")
    print("=" * 86)
    ...
    experiment = Experiment(
        name="Sprint 7A.5 RC3 Consistency Demo",
        description="Consistency Engine integration.",
    ...
    for item in leaderboard[:10]:
        ...
        print(
            ...
            f"Cons={item.breakdown.consistency_score:>6.2f} "
            f"Fold={consistency.fold_consistency_score:>6.2f} "
            f"Monthly={consistency.monthly_stability_score:>6.2f} "
            f"Smooth={consistency.equity_smoothness_score:>6.2f} "
            f"Tier={item.tier}"
        )
    ...
    print("=" * 86)
    print("SPRINT 7A.5 RC3 COMPLETED")
    print("=" * 86)
